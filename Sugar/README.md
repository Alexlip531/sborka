...
### Способ 0. Скачать готовый APK с GitHub Releases (САМЫЙ ПРОСТОЙ — без установки чего-либо)

1. Откройте: **https://github.com/Alexlip531/sborka/releases**
2. Найдите последний релиз (сейчас — **v1.0.2**) и раскройте раздел **"Assets"**
3. Скачайте файл **`sugar-1.0.2.apk`** (готовый установочный APK, не ZIP)
4. Установите APK на телефон (см. раздел «Установка APK на телефон»)

> Также APK доступен как артефакт сборки: вкладка **Actions** → последний успешный запуск **"Build APK"** → раздел **Artifacts**.

> ⚠️ **Важно**: каждый раз когда я делаю правки и пушу в `main`, GitHub Actions автоматически собирает новый APK и создаёт новый релиз с тегом `v<версия>` (например, `v1.0.3`). Чтобы получить последнюю версию — всегда качайте файл из **самого верхнего** релиза на странице Releases.
